...
// If there is data, Vacation.find() returns [Vacation]/"vacations" in callback is [Vacation]; else [] => we start adding entries manually
Vacation.find({})
.then(vacations => {
...
module.exports = {
  ...
  addVacationInSeasonListener: async (email, sku) => {
    // if "email" exists, push to sku; else create another entry {email, skus: [sku]}
